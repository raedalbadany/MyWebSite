...
using MyWebSite.Models.TokenAuth;
...
{
    public abstract class MyWebSiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyWebSiteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyWebSiteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyWebSiteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyWebSiteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyWebSiteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyWebSiteDbContext, Task<T>> func)
        {
            T result;
